...
class AddMenuImageAdapter(
    val items: ArrayList<AddMenuImageData>,
...
//            binding.sivAddMenuImage.setImageResource(R.drawable.ic_google)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): AddMenuImageAdapter.ViewHolder {
        val defaultBinding =
            AddMenuNameMenuImageDefaultBinding.inflate(
    ...
    override fun onBindViewHolder(
        holder: AddMenuImageAdapter.ViewHolder,
        position: Int,
    ) {
        if (position == 0)
            {
